...
import kotlinx.android.synthetic.main.activity_fragment2.edt_phone
        ...
        btn_update.setOnClickListener{
            launch {
                ...
                if (strname =="" || strgrade == "") {
                    ...
                    noteDB?.studentDao()?.update(Student_Entity(id = id,name=strname,grade = strgrade,email=strEmail,phone=strPhone,address=strAddress))
